...
{ 
	...
	//上拉输入 
 	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA|RCC_APB2Periph_GPIOD|RCC_APB2Periph_GPIOC,ENABLE);//使能PORTA,PORTE时钟
...
// 	GPIO_Init(GPIOE, &GPIO_InitStructure);//初始化GPIOE2,3,4
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_13;//PE2~4
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPD; //设置成上拉输入
